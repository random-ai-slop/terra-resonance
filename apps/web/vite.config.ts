...
export default defineConfig(async () => {
  ...
  // Pages uses a portable static export with no Sites account or Worker.
  if (process.env.TERRA_DEPLOY_TARGET === 'pages') {
    return { ...common, plugins: [vinext()] };
  }
  ...
  return {
    ...
    plugins: [
      ...
      cloudflare({
        ...
        config: localBindingConfig(d1, r2),
      }),
    ],
  };
});
